package recapproject.hrms.core.validation;
...
public class UserValidation {
	...
	MernisVerificationManager mernisVerificationManager;

	public UserValidation(MernisVerificationManager mernisVerificationManager) {
	...
	public Result checkMernisService(Candidate candidate) {
		...
		var result = mernisVerificationManager.checkMernisService(candidate);
	...
	public Result checkEmail(Employer employer) {
        ...
        Matcher matchEmail = emailPattern.matcher(employer.getEmail());
        ...
        if (matchEmail.matches()) {
            ...
            if (domain.equals(getDomainName(employer).getData())) {
                ...
                return new ErrorResult("uyuşmuyor " + getDomainName(employer).getMessage() +" "+ domain +" "+ getDomainName(employer).getData()); //"Email adresiniz ile Web adresinizin domainleri uyuşmuyor. Lütfen kontrol ediniz.");
            }
        }
    ...
    private DataResult<String> getDomainName(Employer employer) {
        ...
        try {
			...
			if (domain.startsWith("www.")) {
				...
				result = domain.substring(4);
			}
			else{

				result = domain;
			}
			return new SuccessDataResult<>(result, "Başarılı " + result);
