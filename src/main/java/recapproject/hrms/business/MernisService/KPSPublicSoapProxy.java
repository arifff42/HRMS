...
public class KPSPublicSoapProxy implements recapproject.hrms.business.MernisService.KPSPublicSoap {
  private String _endpoint = null;
  private recapproject.hrms.business.MernisService.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new recapproject.hrms.business.MernisService.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public recapproject.hrms.business.MernisService.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
