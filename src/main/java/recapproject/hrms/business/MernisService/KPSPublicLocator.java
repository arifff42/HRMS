...
public class KPSPublicLocator extends org.apache.axis.client.Service implements recapproject.hrms.business.MernisService.KPSPublic {
    ...
    public recapproject.hrms.business.MernisService.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public recapproject.hrms.business.MernisService.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            recapproject.hrms.business.MernisService.KPSPublicSoapStub _stub = new recapproject.hrms.business.MernisService.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (recapproject.hrms.business.MernisService.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                recapproject.hrms.business.MernisService.KPSPublicSoapStub _stub = new recapproject.hrms.business.MernisService.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
