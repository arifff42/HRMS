...
public class FVAKPSPublicSoap
{
    ...
    public FVAKPSPublicSoap(){}

    public FVAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FVAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FVAExtendedSoapSerializationEnvelope envelope= new FVAExtendedSoapSerializationEnvelope(FVAExtendedSoapSerializationEnvelope.VER11);
